                ...
                <div class="ps-container">
                    <div class="header__left">
                        <div class="menu--product-categories">
                            <div class="menu__toggle"><i class="icon-menu"></i><span> {{ __('Categorias') }}</span></div>
                        ...
                        <div class="header__center">
                            <form class="ps-form--quick-search" action="{{ route('public.products') }}" data-ajax-url="{{ route('public.ajax.search-products') }}" method="get">
                                <div class="form-group--icon">
                                    <div class="product-cat-label">{{ __('Todo') }}</div>
                                    <select class="form-control product-category-select" name="categories[]">
                                        <option value="0">{{ __('Todo') }}</option>
                                ...
                                <input class="form-control" name="q" type="text" placeholder="{{ __("Buscar mi artículo...") }}" id="input-search" autocomplete="off">
                                ...
                                <div class="ps-block--user-header">
                                    ...
                                    <div class="ps-block__right">
                                        @if (auth('customer')->check())
                                            ...
                                            <a href="{{ route('customer.logout') }}">{{ __('Salir') }}</a>
                                        @else
                                            <a href="{{ route('customer.login') }}">{{ __('Ingresar') }}</a><a href="{{ route('customer.register') }}">{{ __('Registrarme') }}</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
